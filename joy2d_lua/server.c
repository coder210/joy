...
//
//        log_info("cmd ready %d", conv);
//        k = kh_get(kconn, ctx->conns, conv);
//        if (k != kh_end(ctx->conns)) {
//                log_info("cmd ready %d conn is exists.", conv);
//                return 0;
//        }
//
...
//                        log_error("not frameid=%d", conn->frameid);
//                        return 0;
//                }
//                world = kh_val(ctx->worlds, k);
...
//        k = kh_get(kconn, ctx->conns, conv);
//        if (k == kh_end(ctx->conns)) {
//                log_debug("conn %d is not exists.", conv);
//                return 0;
//        }
//        conn = kh_val(ctx->conns, k);
//        conn->health = 10;
//        log_debug("conn %d heatbaeat", conv);
//        return 0;
//}
//
//static int
...
//        conn = kh_val(ctx->conns, k);
//        if (conn->ready) {
//                log_debug("conn %d is ready.", conv);
//                return 0;
//        }
//
//        k = kh_get(kworld, ctx->worlds, conn->frameid);
//        if (k == kh_end(ctx->worlds)) {
//                log_error("%s: frameid=%d", "not current world", conn->frameid);
//                return 0;
//        }
//
//        world = kh_val(ctx->worlds, k);
